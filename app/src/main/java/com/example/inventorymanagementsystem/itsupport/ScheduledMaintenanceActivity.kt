...
class ScheduledMaintenanceActivity : AppCompatActivity() {
    ...
    private fun renderTickets() {
        val tickets = EmployeeMaintenanceRepository.getTicketsByType(this, MaintenanceType.SCHEDULED)
        ...
        runOnUiThread {
            ...
            if (tickets.isEmpty()) {
                val emptyView = TextView(this).apply {
                    text = "No scheduled maintenance alerts"
                    textSize = 16f
