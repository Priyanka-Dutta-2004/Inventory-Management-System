...
object ITSupportSessionManager {
    private const val preferencesName = "itsupport_session"
    ...
    fun getSession(context: Context): ITSupportSession? {
        ...
        val name = preferences.getString(keyName, null).orEmpty().ifBlank { "IT Support" }
        return ITSupportSession(
            userId = userId,
            name = name,
            email = email,
            role = role,
